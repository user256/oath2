...
WEBMASTER_CREDENTIALS_FILE_PATH = "/home/user256/PycharmProjects/passwords/webmaster_credentials.dat"
...
def parse_command_line_options():
    ...
    parser.add_argument('--secrets_file', type=str, default='/home/user256/PycharmProjects/passwords/credentials.json', help='File path of your Google Client ID and Client Secret')
